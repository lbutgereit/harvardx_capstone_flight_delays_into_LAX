...
an airflight.  The assumption is that arrival delay values are indicative of whether or
not a flight is late.

Section \@ref(model) describes the various investigations into possible
models to be able to predict 
whether the flight was on-time or not.  There were a
...
```{r, average-delay-by-distance, fig.cap="Average arrival delay by distance flown", warning=FALSE}
